...
*/
    ...
    var wrapper = {
		gri :[
			'<div id="' + this.calendarId + '" class="gri_dateRangeCalendar">',
				...
				'<div class="gri_dateRangeOptions" '+ (this.mOpts.autoSubmit ? ' style="display:block" ' : '') +'>',
    ...
    // 把时间选择框放到页面中
    $(0 < $('#appendParent').length ? '#appendParent' : '.down-modal').append(wrapper[this.mOpts.theme].join(''));
